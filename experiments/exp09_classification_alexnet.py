"""
Experiment 09: Classification Model - AlexNet

This experiment trains an AlexNet model for dog emotion classification.
Configuration: standard AlexNet settings
"""
...
from src.models.alexnet_model import AlexNetClassifier, STANDARD_ALEXNET_CONFIG
...
def main():
    """Run Experiment 09: Classification AlexNet."""
    
    # Parse command line arguments
    parser = argparse.ArgumentParser(description='Experiment 09: Classification AlexNet')
    ...
    experiment_name = "exp09_classification_alexnet"
    ...
    model_config = STANDARD_ALEXNET_CONFIG.copy()
