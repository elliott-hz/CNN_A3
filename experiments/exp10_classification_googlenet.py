"""
Experiment 10: Classification Model - GoogLeNet

This experiment trains a GoogLeNet model for dog emotion classification.
Configuration: standard GoogLeNet settings
"""
...
from src.models.googlenet_model import GoogLeNetClassifier, STANDARD_GOOGLENET_CONFIG
...
def main():
    """Run Experiment 10: Classification GoogLeNet."""
    
    # Parse command line arguments
    parser = argparse.ArgumentParser(description='Experiment 10: Classification GoogLeNet')
    ...
    experiment_name = "exp10_classification_googlenet"
    ...
    model_config = STANDARD_GOOGLENET_CONFIG.copy()
    
    # Adjust training configuration for 120 epochs
    training_config = {
        'learning_rate': 0.01,  # Higher learning rate for GoogLeNet
        'batch_size': 32,
        'epochs': 120,
        'optimizer': 'sgd',  # GoogLeNet typically uses SGD
        'weight_decay': 5e-4,
